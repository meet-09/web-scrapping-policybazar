...
def calculatePolicy(area,model,fuel_type,input_variant,input_reg_year,input_policy_expiry,input_claim_choice):
    ...
    try:
        ...
        chrome_options = webdriver.ChromeOptions()
        chrome_options.add_argument('--headless')
        driver = webdriver.Chrome(options=chrome_options,executable_path=r"D:\webdrivers\chromedriver")
        driver.get('https://ci.policybazaar.com/questions?utm_source=&utm_term=&utm_campaign=&utm_medium=&ishome=true')
...
if __name__ == "__main__":
    input_file = csv.DictReader(open('D:/Users/03000253/Documents/Python Scripts/Policybazaar/Sample Input for Meet.csv'))

    with open("D:/Users/03000253/Documents/Python Scripts/Policybazaar/Sample output for Meetv2.csv","w",newline='',encoding="utf-8") as f:
